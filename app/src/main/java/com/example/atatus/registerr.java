...
public class registerr extends AppCompatActivity implements LocationListener {
    public static final String userDetails = "com.example.atatus";
    private EditText
            user, email, pass, name, age, mobile, profession, office,profpass;
    ...
    private void register ()
    {
        ...
        String profpassid = profpass.getText().toString().trim();
        ...
        if (TextUtils.isEmpty(user.getText().toString().trim()) &&
                ...
                && TextUtils.isEmpty(profession.getText().toString().trim()) && TextUtils.isEmpty(office.getText().toString().trim()) && TextUtils.isEmpty(profpass.getText().toString().trim()) && TextUtils.isEmpty(lati.getText().toString().trim()) && TextUtils.isEmpty(longi.getText().toString().trim())) {
        ...
        } else if (TextUtils.isEmpty(profpass.getText().toString().trim())) {
            profpass.setError("Required");
        }else {
                    ...
                    .addOnCompleteListener(this,new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()) {
                                ...
                                Clickme();
                                Toast.makeText(registerr.this, "Registration Successfull", Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(registerr.this, "Please Try again", Toast.LENGTH_SHORT).show();
                            }
    ...
    public void userdata(){
        ...
        userss reg = new userss(userid, emailid, passid, nameid, ageid, mobileid, profid, offid,profpassid);
