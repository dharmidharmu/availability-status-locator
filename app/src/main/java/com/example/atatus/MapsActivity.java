...
public class MapsActivity extends AppCompatActivity
    ...
    private void startGeofence(double lat,double lon) {
        ...
        if( geoFenceMarker != null ) {
            Geofence geofence = createGeofence( lat,lon, GEOFENCE_RADIUS );
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        drawGeofence();
        DatabaseReference ref = FirebaseDatabase.getInstance().getReference().child("location").child(mAuth.getUid()).child("Location");
    ...
    private Geofence createGeofence( LatLng latLng, float radius ) {
        Log.i("dharmesh", latLng.toString());
    ...
    private Geofence createGeofence( double lat,double lon, float radius ) {
